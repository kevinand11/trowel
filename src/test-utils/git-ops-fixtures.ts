...
export function noopGitOps(overrides: Partial<GitOps> = {}): GitOps {
	return {
		...
		worktreeAdd: noop,
		worktreeAddNewBranch: noop,
		worktreeRemove: noop,
		worktreeList: emptyWorktreeList,
		restoreAll: noop,
		cleanUntracked: noop,
		cleanAll: noop,
		isWorkingTreeCleanIn: trueAsync,
		statusShortIn: emptyStatus,
		isAncestor: falseAsync,
		...
		nonMergeCommitSubjects: emptyBranchList,
